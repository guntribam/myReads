...
const bookshelves = {
    CURRENTLY_READING: {id: 1, name: "Currently Reading"},
    WANT_TO_READ: {id: 2, name: "Want to read"},
    READ: {id: 3, name: "Read"}
}
        ...
        books: [
            {
                ...
                bookshelf: bookshelves.CURRENTLY_READING
            },
            {
                name: 'Ender\'s Game',
            ...
            },
            {
                ...
                bookshelf: bookshelves.WANT_TO_READ
            },
            {
                ...
                <div>
                    {
                        Object.keys(bookshelves).map(bookshelf =>
                                <Bookshelf
                                    key={bookshelf}
                                    title={bookshelves[bookshelf].name}
                                    books={this.state.books.filter(book => book.bookshelf.id === bookshelves[bookshelf].id)}
                                />
                            )
                    }
                </div>
